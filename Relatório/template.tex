...
\section*{Objetivo}
Este trabalho possui como principal objetivo a pesquisa sistemática, pouco ou nada informada, de soluções aplicada à entrega de encomendas. Neste caso em concreto, a solução que se pretende determinar consiste no melhor percurso a realizar para efetuar uma entrega de um determinado conjunto de encomendas. Para determinar o melhor percurso, são 
